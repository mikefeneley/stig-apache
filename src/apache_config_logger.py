...
class ApacheConfigLogger:
    ...
    def ssi_disabled_errmsg(self, result):
        if result == 0:
            ...
            self.log.write(
                "Add one of the following directives to the apache config file: +IncludesNoExec, -IncludesNoExec, or -Includes.\n\n\n")
    ...
    def http_header_field_limited_errmsg(self, result):
        if result == 0:
            ...
            self.log.write("To fix: ")
            self.log.write(
                "Edit the apache config file and ensure the LimitRequestFieldSize is explicitly configured and set to 8190 or other approved value.\n\n\n")
    ...
    def http_line_limited_errmsg(self, result):
        if result == 0:
            ...
            self.log.write("To fix: ")
            self.log.write(
                "Edit the apache config file and set the LimitRequestLine to 8190 or other approved value. If no LimitRequestLine directives exist, explicitly add the directive and set to 8190.\n\n\n")

    def maxclients_set_errmsg(self, result):
        if result == 0:
            self.log.write("Check SV-36649r2_rule: ")
            self.log.write(
                "The MaxClients directive must be set properly.\n\n")
            self.log.write("To fix: ")
            self.log.write(
                "Set the MaxClients directive to a value of 256 or less, add the directive if it does not exist.\n\n\n")
    ...
    def symlinks_disabled_errmsg(self, result):
        if result == 0:
            ...
            self.log.write("To fix: ")
            self.log.write(
                "Edit the apache config file and set the value of FollowSymLinks to -FollowSymLinks.\n\n\n")
    ...
    def multiviews_disabled_errmsg(self, result):
        if result == 0:
            ...
            self.log.write("To fix: ")
            self.log.write(
                "Edit the apache config file file and add the - to the MultiViews setting, or set the options directive to None.\n\n\n")
    ...
    def indexing_disabled_errmsg(self, result):
        if result == 0:
            ...
            self.log.write("To fix: ")
            self.log.write(
                "Edit the apache config file file and add an - to the Indexes setting, or set the options directive to None.\n\n\n")
    ...
    def http_message_limited_errmsg(self, result):
        if result == 0:
            ...
            self.log.write("To fix: ")
            self.log.write(
                "Edit the apache config file and specify a size for the LimitRequestBody directive.\n\n\n")
    ...
    def request_methods_limited_errmsg(self, result):
        if result == 0:
            ...
            self.log.write("To fix: ")
            self.log.write(
                "Edit the https.conf file and add the following entries for every enabled directory except root: 'Order allow,deny' and 'Deny from all'.\n\n\n")
    ...
    def minspareservers_set_errmsg(self, result):
        if result == 0:
            ...
            self.log.write("To fix: ")
            self.log.write(
                "Set the directive MinSpareServers to a value of between 5 and 10, add the directive if it does not exist.\n\n\n")
    ...
    def startservers_set_errmsg(self, result):
        if result == 0:
            ...
            self.log.write("To fix: ")
            self.log.write(
                "Set the directive StartServers to a value of between 5 and 10, add the directive if it does not exist.\n\n\n")
    ...
    def keepalivetimeout_set_errmsg(self, result):
        if result == 0:
            ...
            self.log.write("To fix: ")
            self.log.write(
                "Set the directive KeepAliveTimeout to a value of less than or equal to 15. Add the directive if it does not exist.\n\n\n")

    def keepalive_set_errmsg(self, result):
        if result == 0:
            self.log.write("SV-32844r2_rule: ")
            self.log.write(
                "The KeepAliveTimeout directive must be enabled.\n\n")
            self.log.write("To fix: ")
            self.log.write(
    ...
    def maxspareservers_set_errmsg(self, result):
        if result == 0:
            ...
            self.log.write(
                "The MaxSpareServers directive must be set properly.\n\n")
            self.log.write("To fix: ")
            self.log.write(
