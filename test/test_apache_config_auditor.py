...
class TestApacheConfigAuditor(unittest.TestCase):
    ...
    def test_ssi_disabled3(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("Options", ["+IncludesNoExec"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_ssi_disabled5(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("Options", ["-Includes"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_http_header_field_limited2(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("LimitRequestFieldSize", ["-1"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_http_header_field_limited3(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("LimitRequestFieldSize", ["8190"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_http_line_limited2(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("LimitRequestLine", ["-1"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_http_line_limited3(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("LimitRequestLine", ["8190"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_maxclients_set2(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("MaxClients", ["300"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_maxclients_set3(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("MaxClients", ["22"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_symlinks_disabled3(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("Options", ["-FollowSymLinks"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_multiviews_disabled3(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("Options", ["+Multiview"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_indexing_disabled3(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("Options", ["+Indexes"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_http_message_limited2(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("LimitRequestBody", ["0"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_http_message_limited3(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("LimitRequestBody", ["1"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_http_message_limited4(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("LimitRequestBody", ["2"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_http_header_limited2(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("LimitRequestFields", ["0"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_http_header_limited3(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("LimitRequestFields", ["1"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_http_header_limited4(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("LimitRequestFields", ["2"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_minspareservers_set2(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("MinSpareServers", ["4"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_minspareservers_set3(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("MinSpareServers", ["5"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_minspareservers_set4(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("MinSpareServers", ["6"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_minspareservers_set5(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("MinSpareServers", ["10"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_minspareservers_set6(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("MinSpareServers", ["11"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_startservers_set_set2(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("StartServers", ["4"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_startservers_set_set3(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("StartServers", ["5"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_startservers_set_set4(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("StartServers", ["6"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_startservers_set_set5(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("StartServers", ["10"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_startservers_set_set6(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("StartServers", ["11"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_keepalivetimeout_set2(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("KeepAliveTimeout", ["15"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_keepalivetimeout_set3(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("KeepAliveTimeout", ["14"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_keepalivetimeout_set4(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("KeepAliveTimeout", ["16"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_keepalive_set2(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("KeepAlive", ["Off"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_maxspareservers_set2(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("MaxSpareServers", ["10"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_maxspareservers_set3(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("MaxSpareServers", ["11"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_maxspareservers_set4(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("MaxSpareServers", ["9"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_ports_configured2(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("Listen", ["[0:0:0:0:0:0:1]:1"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_ports_configured3(self):
        ...
        line = DirectiveInfo(
            DirectiveLine("Listen", ["0.0.0.0"]), 0, 'file.txt')
        test_list.append(line)
    ...
    def test_override_denied2(self):
        test_list = []
        line = DirectiveInfo(
            DirectiveLine("<Directory", ["/>"]), 0, 'file.txt')
        test_list.append(line)
        line = DirectiveInfo(
            DirectiveLine("AllowOverride", ["All"]), 0, 'file.txt')
        test_list.append(line)
        line = DirectiveInfo(
            DirectiveLine("</Directory>", [""]), 0, 'file.txt')
        test_list.append(line)
